  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'The destination channel finished work ships to — documents and artifacts publish into it.',
        icon: 'globe',
        since: '2026-07-06',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Publish and unpublish documents and artifacts, read the feed, receive signed webhooks.',
        icon: 'globe',
        since: '2026-07-06',
      },
      {
    ...
    items: [
      {
        ...
        description:
          'Connect an outlet to your Beehiiv newsletter — articles become email-safe drafts you send from Beehiiv.',
        icon: 'plug',
        since: '2026-07-03',
      },
    ],
