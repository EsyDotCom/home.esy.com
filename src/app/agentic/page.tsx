...
export const metadata = {
  ...
  keywords:
    "The Marketing Engineer, agentic workflows, AI agents, frontier models, Claude Code, Cursor, multi-agent architecture, workflow engine, digital products, solopreneur",
  alternates: {
    canonical: "/agentic/",
  },
  openGraph: {
