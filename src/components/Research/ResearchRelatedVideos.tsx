...
import { type ResearchVideo, formatDuration } from "@/data/research-videos";
import { navyCalmLightTheme as theme } from "@/lib/theme";

export interface ResearchRelatedVideosProps {
  videos: ResearchVideo[];
}

export function ResearchRelatedVideos({ videos }: ResearchRelatedVideosProps) {
